...
public interface LPMLNListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LPMLNParser#aggregate_atom}.
	 * @param ctx the parse tree
	 */
	void enterAggregate_atom(LPMLNParser.Aggregate_atomContext ctx);
	/**
	 * Exit a parse tree produced by {@link LPMLNParser#aggregate_atom}.
	 * @param ctx the parse tree
	 */
	void exitAggregate_atom(LPMLNParser.Aggregate_atomContext ctx);
	/**
	 * Enter a parse tree produced by {@link LPMLNParser#aggregate_expr}.
	 * @param ctx the parse tree
	 */
	void enterAggregate_expr(LPMLNParser.Aggregate_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link LPMLNParser#aggregate_expr}.
	 * @param ctx the parse tree
	 */
